...
const create = async (req, res) => {
  res.send(await table.MaterialUomModel.create(req));
};

const get = async (req, res) => {
  res.send(await table.MaterialUomModel.get(req));
};
...
const deleteById = async (req, res) => {
  ...
  res.send(await table.MaterialUomModel.deleteById(req));
};
...
const update = async (req, res) => {
  ...
  res.send(await table.MaterialUomModel.update(req));
};
